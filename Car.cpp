...
Car::Car(SDL_Renderer* renderer, int x, int y, int width, int height, int speed, int i, int j)
...
void Car::onCrossroad(int i, int height, int j, int width){
    ...
    if (i == 0 && direction == up)
        direction = left;
    else if (i == height - 1 && direction == down)
        direction = right;
    else if (j == 0 && direction == left)
        direction = down;
    else if (j == width - 1 && direction == right)
        direction = up;
    else{
